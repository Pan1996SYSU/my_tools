...
input_path = r"Z:\2-现场取图\CYS.230732-01-激光清洗机LDP\1-原图\20231123\误判"
output_path = r'Z:\2-现场取图\CYS.230732-01-激光清洗机LDP\1-原图\20231123\误判-pwz已处理'
...
for i, path in enumerate(img_path_list):
    try:
        ...
        Regions = ha.threshold(Image, 220, 255)
