...
for img_path in img_path_list:
    try:
        ...
        Regions = ha.threshold(ImageGauss, 50, 255)
        ConnectedRegions = ha.connection(Regions)
        SelectedRegions = ha.select_shape(ConnectedRegions, 'area', 'and', 10000, 900000)
        SelectedRegions1 = ha.select_shape(SelectedRegions, 'roundness', 'and', 0.1, 1.0)
        SelectedRegions2 = ha.select_shape(SelectedRegions1, 'height', 'and', 1000, 1700)
